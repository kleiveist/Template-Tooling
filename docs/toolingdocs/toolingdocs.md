...
- 🗂️ [Overview](case-study/case-study.md)
- 📝 [Case-study guidelines](case-study/CASE-STUDY-GUIDELINES.md)
- 📝 [Template compatibility audit](case-study/TEMPLATE-COMPATIBILITY.md)

## 📁 Development
- 🗂️ [Overview](development/development.md)
...
## 📁 Integration
- 🗂️ [Overview](integration/integration.md)
...
## 📁 Reference
- 🗂️ [Overview](reference/reference.md)
